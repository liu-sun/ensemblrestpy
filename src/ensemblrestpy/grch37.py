...
def _(id: list, callback=None, response_format='json'):
    return post(f"archive/id", params=dict(callback=callback), response_format=response_format, json={"ids": id})
...
def sequence_id_post(callback=None, db_type=None, end=None, expand_3prime=None, expand_5prime=None, format=None,
...
def sequence_region_post(species: str, callback=None, coord_system=None, coord_system_version=None, expand_3prime=None,
